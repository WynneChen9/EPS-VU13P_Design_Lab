#!/usr/bin/env bash
#**********************************************************************************************************
# Vivado (TM) v2024.2_AR37126 (64-bit)
#
# Script generated by Vivado on Mon Mar 10 14:52:24 CST 2025
...
#
# Usage        : db.sh
#                db.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                db.sh [-reset_run]
#                db.sh [-reset_log]
#                db.sh [-help]
#
...
#                script (type 'db.sh -help' for more information).
#
...
# script info
echo -e "db.sh - Script generated by export_simulation (Vivado v2024.2_AR37126 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./db.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../led_chaser.gen/sources_1/bd/db/ipshared/814a/hdl/verilog" +incdir+"../../../../led_chaser.gen/sources_1/bd/db/ipshared/1017/hdl/verilog" +incdir+"../../../../led_chaser.gen/sources_1/bd/db/ipshared/4506/hdl" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.db xil_defaultlib.glbl -o db_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./db_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/wynnechen/project/haps-sx/lab/lab2/led_chaser/led_chaser.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key db_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc db_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./db.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: db.sh [-help]\n\
Usage: db.sh [-step]\n\
Usage: db.sh [-lib_map_path]\n\
Usage: db.sh [-reset_run]\n\
Usage: db.sh [-reset_log]\n\
Usage: db.sh [-keep_index]\n\
Usage: db.sh [-noclean_files]\n\n\
