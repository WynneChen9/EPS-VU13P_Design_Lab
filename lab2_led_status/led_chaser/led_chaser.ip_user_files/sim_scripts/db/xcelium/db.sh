...
compile()
{
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../led_chaser.gen/sources_1/bd/db/ipshared/814a/hdl/verilog" +incdir+"../../../../led_chaser.gen/sources_1/bd/db/ipshared/1017/hdl/verilog" +incdir+"../../../../led_chaser.gen/sources_1/bd/db/ipshared/4506/hdl" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.db xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.db -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/wynnechen/project/haps-sx/lab/lab2/led_chaser/led_chaser.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log db_sc.so .tmp_log xcelium_lib waves.shm c.obj)
