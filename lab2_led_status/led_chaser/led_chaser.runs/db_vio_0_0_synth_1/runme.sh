...
HD_PWD='/home/wynnechen/project/EPS_VU13P/lab/lab2_led_status/led_chaser/led_chaser.runs/db_vio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log db_vio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source db_vio_0_0.tcl
