...
HD_PWD='/home/wynnechen/project/EPS_VU13P/lab/lab2_led_status/led_chaser/led_chaser.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log db_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source db_wrapper.tcl -notrace
